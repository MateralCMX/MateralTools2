...
{
    public partial class ExportNugetPackageFileControl : UserControl
    {
        public ExportNugetPackageFileControl()
        {
            InitializeComponent();
        }
        ...
        private ExportNugetPackageFileManager _epfMa;
        #endregion
        #region 私有方法
        /// <summary>
        /// 验证
        ...
        {
            /*重置导出对象*/
            _epfMa = new ExportNugetPackageFileManager
            {
            ...
            /*重置目标文件夹*/
            _targetPath = @"E:\Project\MateralTools\Application\NugetPackage";
            /*重置代码文件夹*/
        ...
        /// <param name="e"></param>
        private void ExportNugetPackageFileControl_Load(object sender, EventArgs e)
        {
            ResetInfo();
        }
        /// <summary>
