...
namespace MateralTools.MHttpRequest.Manager
{
    ...
    public class HttpRequestManager
    {
        ...
        {
            if (url.MIsNullOrEmpty()) throw new ArgumentNullException(nameof(url), "Url地址不能为空");
            if (!url.MIsURL()) throw new ArgumentException("Url地址错误", nameof(url));
            ...
            if (httpResponseMessage.StatusCode != HttpStatusCode.OK)
                throw new MHttpRequestException(httpResponseMessage.StatusCode, result);
            return result;
        }
        /// <summary>
        /// 发送Get请求
