...
namespace MateralTools.MVerify
{
    ...
    public static class StringExtended
    {
        ...
        /// false不是文件名
        /// </returns>
        public static bool MIsAbsoluteDirectoryPath(this string inputStr)
        {
            return inputStr.MVerifyRegex(RegexData.REG_AbsoluteDirectoryPath, true);
        }
        /// <summary>
        /// 获取输入字符串中所有的文件夹绝对路径
        /// </summary>
        ...
        /// 字符串中所有的文件名
        /// </returns>
        public static MatchCollection MGetAbsoluteDirectoryPathInStr(this string inputStr)
        {
            return inputStr.MGetVerifyRegex(RegexData.REG_AbsoluteDirectoryPath, false);
        }
        /// <summary>
        /// 验证输入字符串是否为手机号码
        /// </summary>
